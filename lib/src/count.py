...
acceptableFileExtensions.extend([".cpp", ".hpp"])
...
res += 'Totals\n'
res += '---------------------' + '\n'
res += 'Lines:         ' + str(lineCount) + '\n'
res += 'Blank lines:   ' + str(totalBlankLineCount) + '\n'
res += 'Comment lines: ' + str(totalCommentLineCount) + '\n'
res += 'Code lines:    ' + str(lineCount - totalBlankLineCount - totalCommentLineCount) + '\n'
